package com.shan.sample.errorfunction;
...
public class ErrorFunction {
    ...
    public static double phi(double x, double mean, double sdev) {
        return (1.0 + erf((x - mean) / (sdev * Math.sqrt(2.0)))) / 2.0 ;
    }
...
//        double x = Double.parseDouble(args[0]);
        ...
        /**  Cumulative test **/
        System.out.println(Math.abs(100 - phi(80, 70, 10)));
        System.out.printf("%.2f\n", Math.abs((1 - phi(80, 70, 10)) * 100));
        System.out.printf("%.2f\n", Math.abs((1 - phi(60, 70, 10)) * 100));
        System.out.printf("%.2f\n", Math.abs(phi(60, 70, 10) * 100));
